...
const enroll = new EmbedBuilder()
        ...
        .addFields(
          { name: '**GUIDELINES**:-', value: 'Step 1-> Use the **/biome-details** command to view the available Kingdoms and learn more about them. \n Step 2-> After going through the kingdoms, use the **/biome-selector** command to select a Kingdom of your choosing.\n Step 3-> Use the **/avatar-details** command to view the available Avatars and learn more about them. \n Step 4-> After going through the avatars, use the **/avatar-selector** command to select an Avatar of your choosing. \n Step 5-> Use the **/help** command to learn more about the game mechanics.'},
          { name: '\u200B', value: '\u200B' },
        )
